 ...
 * Get payment by ID.
 *
 * This `{ func } _getPaymentByID is used to get payments by ID.
 *
 * @param {string} id  Receive "id", Validate client and return payment by its ID.
 *
 * @return {Object} `{ payment }`
 */
PieCard.prototype._getPaymentById = async function (id) {
 ...
 * Create payment.
 *
 * This `{ func } _createPayment is used to create payments.
 *
 ...
 * @return {Object} `{ payment }`
 */
PieCard.prototype._createPayment = async function (data) {
  const clientValidation = this._validateClientCredentials();
